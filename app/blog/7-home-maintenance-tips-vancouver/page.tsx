    ...
    <>
      ...
      <article className="py-16 md:py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-text-muted text-[13px] mb-3">2025-04-13</p>
          <h1 className="text-[28px] md:text-[38px] font-semibold text-brio-navy font-heading mb-8 leading-tight">
            7 Home Maintenance Tips for Vancouver Homeowners: Protect Your Property Year-Round
          </h1>
          <div className="prose max-w-none">
            <p className="text-text-body text-[16px] leading-relaxed mb-4">Discover essential home maintenance tips for Vancouver homeowners to protect your property year-round with expert advice from BRIO Construction.</p>
          </div>
