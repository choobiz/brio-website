    ...
    <>
      ...
      <article className="py-16 md:py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-text-muted text-[13px] mb-3">2025-04-20</p>
          <h1 className="text-[28px] md:text-[38px] font-semibold text-brio-navy font-heading mb-8 leading-tight">
            Construction Project Manager Responsibilities: A Day in the Life at BRIO
          </h1>
          <div className="prose max-w-none">
            <p className="text-text-body text-[16px] leading-relaxed mb-4">Discover the essential construction project manager responsibilities in a typical day at BRIO, ensuring successful project execution and teamwork.</p>
          </div>
