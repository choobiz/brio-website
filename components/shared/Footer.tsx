  ...
  return (
    <footer className="bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[180px_1fr_1fr_1fr] gap-8">
          {/* Brand */}
          <div>
            ...
            <div className="flex gap-2">
              ...
              <a href={COMPANY.social.instagram} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-brio-navy flex items-center justify-center hover:bg-brio-navy/80 transition-colors" aria-label="Instagram">
              ...
              <a href={COMPANY.social.houzz} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-brio-navy flex items-center justify-center hover:bg-brio-navy/80 transition-colors" aria-label="Houzz">
                <span className="text-white text-[11px] font-bold">H</span>
              </a>
              <a href={COMPANY.social.google} target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-brio-navy flex items-center justify-center hover:bg-brio-navy/80 transition-colors" aria-label="Google">
          ...
          {/* Get in Touch */}
          <div>
            <h5 className="text-brio-navy text-[13px] font-bold uppercase tracking-wider mb-3">Get in Touch</h5>
            <ul className="space-y-3">
              <li className="flex items-start gap-2.5">
                <MapPin className="w-4 h-4 text-brio-navy shrink-0 mt-0.5" />
                <span className="text-text-body text-[13px]">{COMPANY.address}</span>
              </li>
              <li>
                <a href={`tel:${COMPANY.phoneClean}`} className="flex items-center gap-2.5 text-text-body text-[13px] hover:text-brio-navy transition-colors">
                  <Phone className="w-4 h-4 text-brio-navy shrink-0" />
                  {COMPANY.phone}
                </a>
              </li>
              <li>
                <a href={`mailto:${COMPANY.email}`} className="flex items-center gap-2.5 text-text-body text-[13px] hover:text-brio-navy transition-colors">
                  <Mail className="w-4 h-4 text-brio-navy shrink-0" />
                  {COMPANY.email}
                </a>
              </li>
            </ul>
      ...
      <div className="border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col md:flex-row justify-between items-center gap-2">
          <p className="text-[12px] text-text-muted">&copy; {year} Built by Brio All Rights Reserved</p>
          <div className="flex gap-1 text-[12px] text-text-muted items-center">
