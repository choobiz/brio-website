...
export const metadata: Metadata = {
  title: "North Vancouver Construction & Renovation Services",
  description: "BRIO Construction serves North Vancouver with expert home renovations, custom home construction, and commercial renovations. Get your free estimate today.",
};
      ...
      <section className="bg-brio-light-gray py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-[32px] md:text-[42px] font-semibold text-brio-navy font-heading mb-6">
            North Vancouver Construction & Renovation Services
          </h1>
          <p className="text-text-body text-[16px] md:text-[18px] leading-relaxed mb-8">
            BRIO Construction is proud to serve North Vancouver with expert construction and renovation services.
