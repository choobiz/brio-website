...
export const metadata: Metadata = {
  ...
  description: "Avoid common renovation mistakes with our guide. Discover 6 essential tips to ensure your project is a success.",
};
      ...
      <article className="py-16 md:py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-[28px] md:text-[38px] font-semibold text-brio-navy font-heading mb-8 leading-tight">
            Avoid These 6 Renovation Mistakes for a Successful Project
          </h1>
          <div className="prose max-w-none">
            <p className="text-text-body text-[16px] leading-relaxed mb-4">Avoid common renovation mistakes with our guide. Discover 6 essential tips to ensure your project is a success.</p>
          </div>
