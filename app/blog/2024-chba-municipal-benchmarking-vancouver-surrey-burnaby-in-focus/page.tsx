    ...
    <>
      ...
      <article className="py-16 md:py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-text-muted text-[13px] mb-3">2025-04-07</p>
          ...
          <div className="prose max-w-none">
            <p className="text-text-body text-[16px] leading-relaxed mb-4">Explore the 2024 CHBA Municipal Benchmarking for Vancouver, Surrey, and Burnaby, and discover key insights for local construction trends. CHBA Municipal Benchmarking.</p>
          </div>
